// OldSleepyEngine.cpp : Defines the entry point for the application.
//
#include "pch.h"
...
OldSleepyEngine::OldSleepyEngine(HINSTANCE hInstance)
{
    m_hAppInstance = hInstance;
}

void OldSleepyEngine::InitD3D()
{
...
void OldSleepyEngine::EnableAdditionalD3D12Debug()
{
...
void OldSleepyEngine::CreateDevice()
{
...
void OldSleepyEngine::Check4xMSAAQualitySupportOld()
{
...
void OldSleepyEngine::CreateCommandObjects()
{
...
void OldSleepyEngine::CreateSwapChain()
{
    delete m_pSwapChain;
...
void OldSleepyEngine::CreateDescriptorHeaps()
{
...
void OldSleepyEngine::CreateRenderTargetView()
{
...
void OldSleepyEngine::CreateDepthStencilView()
{
...
void OldSleepyEngine::SetViewport()
{
...
void OldSleepyEngine::SetScissorRect()
{
...
int OldSleepyEngine::Initialize()
{
    try
    {
...
void OldSleepyEngine::BuildDescriptorHeaps()
{
...
void OldSleepyEngine::BuildConstantBuffers()
{
...
D3D12_CPU_DESCRIPTOR_HANDLE OldSleepyEngine::GetCurrentBackBufferView()const
{
...
ID3D12Resource* OldSleepyEngine::GetCurrentBackBuffer()const
{
    return m_pSwapChainBuffer[m_currentBackBufferOffset];
}

D3D12_CPU_DESCRIPTOR_HANDLE OldSleepyEngine::GetDepthStencilView()const
{
    return m_pDsvHeap->GetCPUDescriptorHandleForHeapStart();
}

void OldSleepyEngine::Release()
{
    RELEASE(m_pDevice);
    RELEASE(m_pFence);
    RELEASE(m_pRtvHeap);
...
ATOM OldSleepyEngine::RegisterWindowClass()
{
    WNDCLASSEXW wcex;
...
void OldSleepyEngine::InitWindow(int nCmdShow)
{
...
void OldSleepyEngine::FlushCommandQueue()
{
...
void OldSleepyEngine::BuildBoxGeometry()
{
...
void OldSleepyEngine::BuildBoxGeometryBis()
{
...
//void OldSleepyEngine::Draw(ID3D12DescriptorHeap* pCBVHeap, ID3D12RootSignature* pRootSignature, Mesh* mesh)
void OldSleepyEngine::Draw()
{
