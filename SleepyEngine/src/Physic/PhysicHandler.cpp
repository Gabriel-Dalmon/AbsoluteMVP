...
void PhysicHandler::Initialize()
{

}

void PhysicHandler::UNSAFE_AddEntity(Entity* entity)
{
...
void PhysicHandler::UNSAFE_RemoveEntity(Entity* entity)
{
...
void PhysicHandler::Update(float deltaTime)
{
	for (int i=0; i < m_entitiesDataList.size(); i++)
	{
...
bool PhysicHandler::CheckCollision(PhysicEntityData* self, PhysicEntityData* target)
{
