...
void Mesh::Init(ID3D12Device* device, ID3D12GraphicsCommandList* commandList, std::vector<VertexTexture>* vertices, std::vector<uint16_t>* indices)
{
	m_pName = "boxGeo";
...
void Mesh::Init(ID3D12Device* device, ID3D12GraphicsCommandList* commandList, std::vector<VertexColor>* vertices, std::vector<uint16_t>* indices)
{
	m_pName = "boxGeo";
