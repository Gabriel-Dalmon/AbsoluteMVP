...
ID3DBlob* OldShader::CompileShader(const std::wstring& filename, const D3D_SHADER_MACRO* defines, const std::string& entrypoint, const std::string& target)
{
	UINT compileFlags = 0;
...
void OldShader::CompileVS(std::wstring fileName)
{
	m_pVSByteCode = CompileShader(fileName, nullptr, "VS", "vs_5_0");
}

void OldShader::CompilePS(std::wstring fileName)
{
