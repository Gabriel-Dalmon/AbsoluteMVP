...
public:
	...
	int GetRemainingDirtyFramesCount() { return m_remainingDirtyFrameCount; };
	void DecrementRemainingDirtyFramesCount() { --m_remainingDirtyFrameCount; };
...
private:
	...
	int m_remainingDirtyFrameCount = 0;
};
